...
class Veronte:
    ...
    def __init__(self,Veronteport,Verontebitrate,modeselect):
        ...
        self.Data = ''
        self.packet = {}
        self.dataDictionary = {'altitude_AGL':0,'altitude_AGL_set':0,'altitude_ABS':0,'heading':0,'compass':0,'attitude_pitch':0,'attitude_roll':0,'vertical_speed_KTS':0,
    ...
    def packetStruct(self):
        ...
        try:
                ...
                self.packet = {'altitude_AGL':round(random.uniform(0,100),2),'altitude_AGL_set':round(random.uniform(0,100),2),'altitude_ABS':round(random.uniform(0,100),2),'heading':round(random.uniform(0,100),2),'compass':round(random.uniform(0,100),2),'attitude_pitch':round(random.uniform(0,100),2),'attitude_roll':round(random.uniform(0,100),2),'vertical_speed_KTS':round(random.uniform(0,100),2),
