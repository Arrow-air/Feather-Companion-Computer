...
class VESCCAN:
    ...
    def parse_frame(self, command, data, unit_id):
        ...
        if (command == 9738 or command == 39) and unit_id in range(10,17):#0x260A:  # CAN_PACKET_BMS_V_TOT
            #print(command)
            #print(unit_id)
        ...
        elif (command == 10506 or command == 42) and unit_id in range(10,17):#0x291A:  # CAN_PACKET_BMS_V_CELL
            #print(command)
            #print(unit_id)
            '''
        ...
        elif (command == 10762 or command == 43) and unit_id in range(10,17):#0x2A7A:  # CAN_PACKET_BMS_BAL
            #print(command)
            #print(unit_id)
        ...
        elif (command == 11274 or command == 45) and unit_id in range(10,17):#0x2C1A:  # CAN_PACKET_BMS_HUM
            #print(command)
            #print(unit_id)
        ...
        elif (command == 11530 or command == 46) and unit_id in range(10,17):#0x2D1A:  # CAN_PACKET_BMS_SOC_SOH_TEMP_STAT
            #print(command)
            #print(unit_id)
